...
def test_userbot_status_endpoint(mock_userbot):
    ...
    mock_userbot.auth.get_me = AsyncMock(return_value={
        "id": 123456789,
        "username": "testuser",
        "first_name": "Test",
        "last_name": "User",
...
def test_sign_in_password_endpoint(mock_userbot):
    ...
    response = client.post("/api/v1/auth/sign-in-password", json={
...
class TestTelegramAuth:
    ...
    def test_send_code(self, mock_client_class):
        ...
        mock_client.send_code = AsyncMock(return_value=MagicMock(phone_code_hash="test_hash"))
